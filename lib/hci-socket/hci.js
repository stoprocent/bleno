...
const hciSocket = require('@stoprocent/bluetooth-hci-socket');
...
class Hci extends EventEmitter {
  constructor (options) {
    ...
    const BluetoothHciSocket = options.hciDriver ? hciSocket.loadDriver(options.hciDriver) : hciSocket.default;
